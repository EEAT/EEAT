 ...
 * @author 
 */
public class PRCommentPrinterNodeModel extends NodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(PRCommentPrinterNodeModel.class);
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(PRCommentPrinterNodeModel.CFGKEY_COUNT,
     ...
     */
    protected PRCommentPrinterNodeModel() {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
        ...
        allColSpecs[1] = 
            new DataColumnSpecCreator("Pull Request Comment ID", IntCell.TYPE).createSpec();
        allColSpecs[2] = 
            new DataColumnSpecCreator("User ID", StringCell.TYPE).createSpec();
        allColSpecs[3] = 
            new DataColumnSpecCreator("Pull Request Comment Created at", StringCell.TYPE).createSpec();
        allColSpecs[4] = 
            new DataColumnSpecCreator("PullRequestComment Message Body", StringCell.TYPE).createSpec();
        allColSpecs[5] = 
