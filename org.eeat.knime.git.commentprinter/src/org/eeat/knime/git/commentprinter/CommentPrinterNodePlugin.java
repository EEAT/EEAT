 ...
 * @author 
 */
public class CommentPrinterNodePlugin extends Plugin {
    // The shared instance.
    private static CommentPrinterNodePlugin plugin;

    /**
     * The constructor.
     */
    public CommentPrinterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CommentPrinterNodePlugin getDefault() {
        return plugin;
    }
