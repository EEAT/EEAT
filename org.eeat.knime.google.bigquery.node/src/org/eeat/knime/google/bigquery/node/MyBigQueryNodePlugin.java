 ...
 * @author 
 */
public class MyBigQueryNodePlugin extends Plugin {
    // The shared instance.
    private static MyBigQueryNodePlugin plugin;

    /**
     * The constructor.
     */
    public MyBigQueryNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MyBigQueryNodePlugin getDefault() {
        return plugin;
    }
