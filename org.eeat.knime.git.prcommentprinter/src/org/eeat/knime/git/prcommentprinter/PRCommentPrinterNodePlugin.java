 ...
 * @author 
 */
public class PRCommentPrinterNodePlugin extends Plugin {
    // The shared instance.
    private static PRCommentPrinterNodePlugin plugin;

    /**
     * The constructor.
     */
    public PRCommentPrinterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PRCommentPrinterNodePlugin getDefault() {
        return plugin;
    }
