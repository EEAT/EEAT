 ...
 * @author EEAT
 */
public class EEATTreeDiffNodePlugin extends Plugin {
    // The shared instance.
    private static EEATTreeDiffNodePlugin plugin;

    /**
     * The constructor.
     */
    public EEATTreeDiffNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EEATTreeDiffNodePlugin getDefault() {
        return plugin;
    }
