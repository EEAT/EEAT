 ...
 * @author 
 */
public class IssueCommentPrinterNodePlugin extends Plugin {
    // The shared instance.
    private static IssueCommentPrinterNodePlugin plugin;

    /**
     * The constructor.
     */
    public IssueCommentPrinterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IssueCommentPrinterNodePlugin getDefault() {
        return plugin;
    }
