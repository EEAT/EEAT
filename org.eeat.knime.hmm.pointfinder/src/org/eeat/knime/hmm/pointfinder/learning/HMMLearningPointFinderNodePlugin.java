 ...
 * @author 
 */
public class HMMLearningPointFinderNodePlugin extends Plugin {
    // The shared instance.
    private static HMMLearningPointFinderNodePlugin plugin;

    /**
     * The constructor.
     */
    public HMMLearningPointFinderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HMMLearningPointFinderNodePlugin getDefault() {
        return plugin;
    }
