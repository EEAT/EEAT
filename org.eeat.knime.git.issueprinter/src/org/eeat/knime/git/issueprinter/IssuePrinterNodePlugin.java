 ...
 * @author 
 */
public class IssuePrinterNodePlugin extends Plugin {
    // The shared instance.
    private static IssuePrinterNodePlugin plugin;

    /**
     * The constructor.
     */
    public IssuePrinterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IssuePrinterNodePlugin getDefault() {
        return plugin;
    }
