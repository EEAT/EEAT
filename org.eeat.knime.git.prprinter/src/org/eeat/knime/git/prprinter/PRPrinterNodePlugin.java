 ...
 * @author 
 */
public class PRPrinterNodePlugin extends Plugin {
    // The shared instance.
    private static PRPrinterNodePlugin plugin;

    /**
     * The constructor.
     */
    public PRPrinterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PRPrinterNodePlugin getDefault() {
        return plugin;
    }
